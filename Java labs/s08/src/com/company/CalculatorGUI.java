...
public class CalculatorGUI {
    ...
    //A Jpanel for standard mode of calculator
    private JPanel standard;

    //A Jpanel for scientific mode of calculator
    ...
    public CalculatorGUI() {
        ...
        copyItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.ALT_MASK));
        jMenuBar.add(menu);
        calculatorFrame.setJMenuBar(jMenuBar);
        makeStandardPanel();
        makeScientificPanel();
        //tab
    ...
    private void makeStandardPanel() {
        ...
        keyboardPanel.setToolTipText("keyboard");
        ...
        for (int i = 0; i < 10; i++) {
            ...
            numberButton[i].setToolTipText("number button");
        ...
        for (int i = 0; i < 8; i++) {
            ...
            operatorButton[i].setToolTipText("operator button");
    ...
    /**
     * make KeyboardHandler.
     * The method handle keyboard key.
     */
